...
DOCUMENTATION = '''
---
module: apimanagementproductsubscription
version_added: '2.9'
...
class AzureRMProductSubscriptions(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("ProductSubscription instance doesn't exist")
            ...
            self.log('ProductSubscription instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the ProductSubscription instance')
            ...
            self.log('ProductSubscription instance deleted')
            self.results['changed'] = True
            ...
            self.log('ProductSubscription instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the ProductSubscription instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("ProductSubscription instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the ProductSubscription instance.')
        if found is True:
            return response
