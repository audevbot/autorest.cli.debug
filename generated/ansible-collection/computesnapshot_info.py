...
class AzureRMSnapshotsInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMSnapshotsInfo, self).__init__(self.module_arg_spec, supports_tags=True)
