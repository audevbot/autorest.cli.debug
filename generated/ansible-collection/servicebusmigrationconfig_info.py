...
DOCUMENTATION = '''
---
module: servicebusmigrationconfig_info
version_added: '2.9'
...
- name: MigrationConfigurationsList
  azure.rm.servicebusmigrationconfig.info:
...
class AzureRMMigrationConfigsInfo(AzureRMModuleBase):
    ...
    def get(self):
        ...
        self.url = ('/subscriptions' +
                    ...
                    '/{{ migration_configuration_name }}')
        self.url = self.url.replace('{{ subscription_id }}', self.subscription_id)
        self.url = self.url.replace('{{ resource_group }}', self.resource_group)
        self.url = self.url.replace('{{ namespace_name }}', self.namespace_name)
        self.url = self.url.replace('{{ migration_configuration_name }}', self.name)
