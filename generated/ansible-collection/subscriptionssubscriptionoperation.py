...
DOCUMENTATION = '''
---
module: subscriptionssubscriptionoperation
version_added: '2.9'
...
class AzureRMSubscriptionOperations(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("SubscriptionOperation instance doesn't exist")
            ...
            self.log('SubscriptionOperation instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the SubscriptionOperation instance')
            ...
            self.log('SubscriptionOperation instance deleted')
            self.results['changed'] = True
            ...
            self.log('SubscriptionOperation instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the SubscriptionOperation instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("SubscriptionOperation instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the SubscriptionOperation instance.')
        if found is True:
            return response
