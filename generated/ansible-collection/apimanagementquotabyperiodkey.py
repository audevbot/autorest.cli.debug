...
DOCUMENTATION = '''
---
module: apimanagementquotabyperiodkey
version_added: '2.9'
...
class AzureRMQuotaByPeriodKeys(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("QuotaByPeriodKey instance doesn't exist")
            ...
            self.log('QuotaByPeriodKey instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the QuotaByPeriodKey instance')
            ...
            self.log('QuotaByPeriodKey instance deleted')
            self.results['changed'] = True
            ...
            self.log('QuotaByPeriodKey instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the QuotaByPeriodKey instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("QuotaByPeriodKey instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the QuotaByPeriodKey instance.')
        if found is True:
            return response
