...
DOCUMENTATION = '''
---
module: apimanagementtenantacces
version_added: '2.9'
...
class AzureRMTenantAccess(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("TenantAcces instance doesn't exist")
            ...
            self.log('TenantAcces instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the TenantAcces instance')
            ...
            self.log('TenantAcces instance deleted')
            self.results['changed'] = True
            ...
            self.log('TenantAcces instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the TenantAcces instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("TenantAcces instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the TenantAcces instance.')
        if found is True:
            return response
