...
class AzureRMAlerts(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("Alert instance doesn't exist")
            ...
            self.log('Alert instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the Alert instance')
            ...
            self.log('Alert instance deleted')
            self.results['changed'] = True
            ...
            self.log('Alert instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the Alert instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("Alert instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the Alert instance.')
        if found is True:
            return response
