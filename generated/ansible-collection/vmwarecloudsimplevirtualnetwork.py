...
DOCUMENTATION = '''
---
module: vmwarecloudsimplevirtualnetwork
version_added: '2.9'
...
class AzureRMVirtualNetworks(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("VirtualNetwork instance doesn't exist")
            ...
            self.log('VirtualNetwork instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the VirtualNetwork instance')
            ...
            self.log('VirtualNetwork instance deleted')
            self.results['changed'] = True
            ...
            self.log('VirtualNetwork instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the VirtualNetwork instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("VirtualNetwork instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the VirtualNetwork instance.')
        if found is True:
            return response
