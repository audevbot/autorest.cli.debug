...
class ResourceGroupScenarioTest(ScenarioTest):
    ...
    def test_resource_group(self, resource_group):
        ...
        # containerservice_openshiftmanagedclusters_get
        self.cmd('rest '
                 '--method get '
        ...
        # containerservice_openshiftmanagedclusters_get_1
        self.cmd('rest '
                 '--method get '
        ...
        # containerservice_openshiftmanagedclusters_get_2
        self.cmd('rest '
                 '--method get '
        ...
        # containerservice_openshiftmanagedclusters_put
        body = (
                 '{'
                 '  "location": "location1",'
                 '  "tags": {'
        ...
        # containerservice_openshiftmanagedclusters_patch
        self.cmd('rest '
                 '--method patch '
                 '--uri /subscriptions/{sub}/resourceGroups/{rg}/providers/Microsoft.ContainerService/openShiftManagedClusters/{OPEN_SHIFT_MANAGED_CLUSTER_NAME}?api-version=2019-04-30 '
                 , checks=[
        ...
        # containerservice_openshiftmanagedclusters_delete
        self.cmd('rest '
                 '--method delete '
                 '--uri /subscriptions/{sub}/resourceGroups/{rg}/providers/Microsoft.ContainerService/openShiftManagedClusters/{OPEN_SHIFT_MANAGED_CLUSTER_NAME}?api-version=2019-04-30 '
                 , checks=[
