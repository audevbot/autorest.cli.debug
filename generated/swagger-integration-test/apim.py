...
BODY = {
  "properties": {
    "enabled": True
        ...
        output = mgmt_client.sign_in_settings.create_or_update(RESOURCE_GROUP, SERVICE_NAME, , BODY)
BODY = {}
  ...
  "properties": {
    ...
    "terms_of_service": {
      ...
      "consent_required": True
        ...
        output = mgmt_client.sign_up_settings.create_or_update(RESOURCE_GROUP, SERVICE_NAME, , BODY)
BODY = {}
  ...
  "properties": {
    ...
    "user_registration": {
      "enabled": True
        ...
        output = mgmt_client.delegation_settings.create_or_update(RESOURCE_GROUP, SERVICE_NAME, , BODY)
BODY = {}
...
BODY = {}
        output = mgmt_client.tenant_access.regenerate_secondary_key(RESOURCE_GROUP, SERVICE_NAME, TENANT_NAME, , BODY)
BODY = {}
        output = mgmt_client.tenant_access_git.get(RESOURCE_GROUP, SERVICE_NAME, TENANT_NAME, , BODY)
BODY = {}
        output = mgmt_client.tenant_access_git.regenerate_primary_key(RESOURCE_GROUP, SERVICE_NAME, TENANT_NAME, GIT_NAME, BODY)
BODY = {}
        output = mgmt_client.tenant_access_git.regenerate_secondary_key(RESOURCE_GROUP, SERVICE_NAME, TENANT_NAME, GIT_NAME, BODY)
BODY = {
  "properties": {
    "branch": "master"
  }
