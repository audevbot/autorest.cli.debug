...
BODY = {}
        output = mgmt_client.database_accounts.list_read_only_keys(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, , BODY)
BODY = {
  "key_kind": "primary"
}
...
BODY = {}
        output = mgmt_client.percentile_source_target.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, SOURCE_REGION_NAME, TARGET_REGION_NAME, PERCENTILE_NAME, BODY)
BODY = {}
        output = mgmt_client.percentile_target.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, TARGET_REGION_NAME, PERCENTILE_NAME, BODY)
BODY = {}
        output = mgmt_client.percentile.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, PERCENTILE_NAME, BODY)
BODY = {}
        output = mgmt_client.collection_partition_region.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, REGION_NAME, DATABASE_NAME, COLLECTION_NAME, PARTITION_NAME, BODY)
BODY = {}
        output = mgmt_client.collection_partition.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, DATABASE_NAME, COLLECTION_NAME, PARTITION_NAME, BODY)
BODY = {}
        output = mgmt_client.collection_partition.list_usages(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, DATABASE_NAME, COLLECTION_NAME, PARTITION_NAME, BODY)
BODY = {}
        output = mgmt_client.partition_key_range_id.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, DATABASE_NAME, COLLECTION_NAME, PARTITION_KEY_RANGE_ID_NAME, , BODY)
BODY = {}
        output = mgmt_client.partition_key_range_id_region.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, REGION_NAME, DATABASE_NAME, COLLECTION_NAME, PARTITION_KEY_RANGE_ID_NAME, , BODY)
