...
def load_arguments(self, _):
    ...
    with self.argument_context('vmwarecs create') as c:
        ...
        c.argument('dedicated_cloud_node_name', id_part=None, help='dedicated cloud node name')
    ...
    with self.argument_context('vmwarecs create') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('dedicated_cloud_service_name', id_part=None, help='dedicated cloud Service name')
        c.argument('location', arg_type=get_location_type(self.cli_ctx))
    ...
    with self.argument_context('vmwarecs create') as c:
        c.argument('resource_group', resource_group_name_type)
        c.argument('referer', id_part=None, help='referer url')
        c.argument('virtual_machine_name', id_part=None, help='virtual machine name')
        c.argument('location', arg_type=get_location_type(self.cli_ctx))
