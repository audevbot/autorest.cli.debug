...
def create_cosmos-db(cmd, client,
    ...
    body['kind'] = kind # str
    body['consistency_policy'] = json.loads(consistency_policy) if isinstance(consistency_policy, str) else consistency_policy
    body['locations'] = json.loads(locations) if isinstance(locations, str) else locations
    ...
    body['capabilities'] = json.loads(capabilities) if isinstance(capabilities, str) else capabilities
    body['virtual_network_rules'] = json.loads(virtual_network_rules) if isinstance(virtual_network_rules, str) else virtual_network_rules
