...
def load_arguments(self, _):
    ...
    with self.argument_context('cosmos-db table database keyspace graph container collection list') as c:
        c.argument('resource_group', id_part=None, help='Name of an Azure resource group.')
        c.argument('account_name', id_part=None, help='Cosmos DB database account name.')
        c.argument('table_name', id_part=None, help='Cosmos DB table name.')
        c.argument('database_name', id_part=None, help='Cosmos DB database name.')
        c.argument('keyspace_name', id_part=None, help='Cosmos DB keyspace name.')
        c.argument('graph_name', id_part=None, help='Cosmos DB graph name.')
        c.argument('container_name', id_part=None, help='Cosmos DB container name.')
        c.argument('name', id_part=None, help='Cosmos DB collection name.')
        c.argument('resource_id', name_arg_type, id_part=None)
        c.argument('rest_body', name_arg_type, id_part=None)
    ...
    with self.argument_context('cosmos-db database list') as c:
        c.argument('resource_group', id_part=None, help='Name of an Azure resource group.')
        c.argument('name', id_part=None, help='Cosmos DB database account name.')
        c.argument('database_rid', id_part=None, help='Cosmos DB database rid.')
        c.argument('resource_id', name_arg_type, id_part=None)
        c.argument('rest_body', name_arg_type, id_part=None)
    name_arg_type = CLIArgumentType(options_list=('--name', '-n'), metavar='NAME')
    ...
    with self.argument_context('cosmos-db database collection list') as c:
        ...
        c.argument('name', id_part=None, help='Cosmos DB database account name.')
        c.argument('database_rid', id_part=None, help='Cosmos DB database rid.')
        c.argument('collection_rid', id_part=None, help='Cosmos DB collection rid.')
        c.argument('resource_id', name_arg_type, id_part=None)
        c.argument('rest_body', name_arg_type, id_part=None)
    name_arg_type = CLIArgumentType(options_list=('--name', '-n'), metavar='NAME')
    ...
    with self.argument_context('cosmos-db region database collection list') as c:
        c.argument('resource_group', id_part=None, help='Name of an Azure resource group.')
        c.argument('name', id_part=None, help='Cosmos DB database account name.')
        c.argument('region', id_part=None, help='Cosmos DB region, with spaces between words and each word capitalized.')
        c.argument('database_rid', id_part=None, help='Cosmos DB database rid.')
        c.argument('collection_rid', id_part=None, help='Cosmos DB collection rid.')
        c.argument('resource_id', name_arg_type, id_part=None)
        c.argument('rest_body', name_arg_type, id_part=None)
    ...
    with self.argument_context('cosmos-db sourceregion targetregion list') as c:
        c.argument('resource_group', id_part=None, help='Name of an Azure resource group.')
        c.argument('name', id_part=None, help='Cosmos DB database account name.')
        c.argument('source_region', id_part=None, help='Source region from which data is written. Cosmos DB region, with spaces between words and each word capitalized.')
        c.argument('target_region', id_part=None, help='Target region to which data is written. Cosmos DB region, with spaces between words and each word capitalized.')
        c.argument('resource_id', name_arg_type, id_part=None)
        c.argument('rest_body', name_arg_type, id_part=None)
    name_arg_type = CLIArgumentType(options_list=('--name', '-n'), metavar='NAME')
    ...
    with self.argument_context('cosmos-db database collection partitionkeyrangeid list') as c:
        ...
        c.argument('database_rid', id_part=None, help='Cosmos DB database rid.')
        c.argument('collection_rid', id_part=None, help='Cosmos DB collection rid.')
        c.argument('partition_key_range_id', id_part=None, help='Partition Key Range Id for which to get data.')
        c.argument('resource_id', name_arg_type, id_part=None)
        c.argument('rest_body', name_arg_type, id_part=None)
    name_arg_type = CLIArgumentType(options_list=('--name', '-n'), metavar='NAME')
