...
def load_arguments(self, _):
    ...
    with self.argument_context('apimgmt api create') as c:
        ...
        c.argument('subscription_key-parameter-names', id_part=None, help='Protocols over which API is made available.')
        ...
        c.argument('api_revision-description', id_part=None, help='Description of the Api Revision.')
        c.argument('api_version-description', id_part=None, help='Description of the Api Version.')
        c.argument('api_version-set-id', id_part=None, help='A resource identifier for the related ApiVersionSet.')
        ...
        c.argument('source_api-id', id_part=None, help='API identifier of the source API.')
        ...
        c.argument('api_version-set', id_part=None, help='Version set details')
    ...
    with self.argument_context('apimgmt api diagnostic create') as c:
        ...
        c.argument('enable_http-correlation-headers', arg_type=get_three_state_flag(), id_part=None, help='Whether to process Correlation Headers coming to Api Management Service. Only applicable to Application Insights diagnostics. Default is true.')
    ...
    with self.argument_context('apimgmt api tagdescription create') as c:
        ...
        c.argument('external_docs-url', id_part=None, help='Absolute URL of external resources describing the tag.')
        c.argument('external_docs-description', id_part=None, help='Description of the external resources describing the tag.')
    ...
    with self.argument_context('apimgmt apiversionset create') as c:
        c.argument('resource_group', id_part=None, help='The name of the resource group.')
        c.argument('service_name', id_part=None, help='The name of the API Management service.')
        c.argument('version_set-id', id_part=None, help='Api Version Set identifier. Must be unique in the current API Management service instance.')
        c.argument('parameters', id_part=None, help='undefined')
        c.argument('description', id_part=None, help='Description of API Version Set.')
        c.argument('version_query-name', id_part=None, help='Name of query parameter that indicates the API Version if versioningScheme is set to `query`.')
        c.argument('version_header-name', id_part=None, help='Name of HTTP header parameter that indicates the API Version if versioningScheme is set to `header`.')
    ...
    with self.argument_context('apimgmt authorizationserver create') as c:
        ...
        c.argument('client_authentication-method', id_part=None, help='Method of authentication supported by the token endpoint of this authorization server. Possible values are Basic and/or Body. When Body is specified, client credentials and other parameters are passed within the request body in the application/x-www-form-urlencoded format.')
        c.argument('token_body-parameters', id_part=None, help='Additional parameters required by the token endpoint of this authorization server represented as an array of JSON objects with name and value string properties, i.e. {"name" : "name value", "value": "a value"}.')
        ...
        c.argument('bearer_token-sending-methods', id_part=None, help='Specifies the mechanism by which access token is passed to the API. ')
        c.argument('client_secret', id_part=None, help='Client or app secret registered with this authorization server.')
        c.argument('resource_owner-username', id_part=None, help='Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner username.')
        c.argument('resource_owner-password', id_part=None, help='Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner password.')
        c.argument('display_name', id_part=None, help='User-friendly authorization server name.')
        c.argument('client_registration-endpoint', id_part=None, help='Optional reference to a page where client or app registration for this authorization server is performed. Contains absolute URL to entity being referenced.')
    ...
    with self.argument_context('apimgmt backend create') as c:
        ...
        c.argument('service_fabric-cluster', id_part=None, help='Backend Service Fabric Cluster Properties')
    ...
    with self.argument_context('apimgmt create') as c:
        ...
        c.argument('notification_sender-email', id_part=None, help='Email address from which the notification will be sent.')
        c.argument('hostname_configurations', id_part=None, help='Custom hostname configuration of the API Management service.')
        c.argument('virtual_network-configuration', id_part=None, help='Virtual network configuration of the API Management service.')
        ...
        c.argument('enable_client-certificate', arg_type=get_three_state_flag(), id_part=None, help='Property only meant to be used for Consumption SKU Service. This enforces a client certificate to be presented on each request to the gateway. This also enables the ability to authenticate the certificate in the policy on the gateway.')
        c.argument('virtual_network-type', arg_type=get_enum_type(['None', 'External', 'Internal']), id_part=None, help='The type of VPN in which API Management service needs to be configured in. None (Default Value) means the API Management service is not part of any Virtual Network, External means the API Management deployment is set up inside a Virtual Network having an Internet Facing Endpoint, and Internal means that API Management deployment is setup inside a Virtual Network having an Intranet Facing Endpoint only.')
    ...
    with self.argument_context('apimgmt identityprovider create') as c:
        ...
        c.argument('signup_policy-name', id_part=None, help='Signup Policy Name. Only applies to AAD B2C Identity Provider.')
        c.argument('signin_policy-name', id_part=None, help='Signin Policy Name. Only applies to AAD B2C Identity Provider.')
        c.argument('profile_editing-policy-name', id_part=None, help='Profile Editing Policy Name. Only applies to AAD B2C Identity Provider.')
        c.argument('password_reset-policy-name', id_part=None, help='Password Reset Policy Name. Only applies to AAD B2C Identity Provider.')
    ...
    with self.argument_context('apimgmt portalsetting signup create') as c:
        ...
        c.argument('terms_of-service', id_part=None, help='Terms of service contract properties.')
