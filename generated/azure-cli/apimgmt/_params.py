...
def load_arguments(self, _):
    ...
    with self.argument_context('apimgmt api create') as c:
        ...
        c.argument('api_type', name_arg_type, id_part=None, help='Type of Api to create. 
...
')
    ...
    with self.argument_context('apimgmt logger create') as c:
        ...
        c.argument('credentials', name_arg_type, id_part=None, help='The name and SendRule connection string of the event hub for azureEventHub logger.
...
')
        ...
        c.argument('notify', name_arg_type, id_part=None, help='Notify change in Subscription State. 
