...
def load_command_table(self, _):
    ...
    with self.command_group('apim api tag-description', apim_sdk, client_factory=cf_apim) as g:
        g.custom_command('create', 'create_apim_api_tag-description')
        g.custom_command('update', 'update_apim_api_tag-description')
        g.custom_command('delete', 'delete_apim_api_tag-description')
        g.custom_command('list', 'list_apim_api_tag-description')
        g.custom_command('show', 'show_apim_api_tag-description')
    with self.command_group('apim api-version-set', apim_sdk, client_factory=cf_apim) as g:
        g.custom_command('create', 'create_apim_api-version-set')
        g.custom_command('update', 'update_apim_api-version-set')
        g.custom_command('delete', 'delete_apim_api-version-set')
        g.custom_command('list', 'list_apim_api-version-set')
        g.custom_command('show', 'show_apim_api-version-set')
    with self.command_group('apim authorization-server', apim_sdk, client_factory=cf_apim) as g:
        g.custom_command('create', 'create_apim_authorization-server')
        g.custom_command('update', 'update_apim_authorization-server')
        g.custom_command('delete', 'delete_apim_authorization-server')
        g.custom_command('list', 'list_apim_authorization-server')
        g.custom_command('show', 'show_apim_authorization-server')
    ...
    with self.command_group('apim identity-provider', apim_sdk, client_factory=cf_apim) as g:
        g.custom_command('create', 'create_apim_identity-provider')
        g.custom_command('update', 'update_apim_identity-provider')
        g.custom_command('delete', 'delete_apim_identity-provider')
        g.custom_command('list', 'list_apim_identity-provider')
        g.custom_command('show', 'show_apim_identity-provider')
    ...
    with self.command_group('apim notification recipient-user', apim_sdk, client_factory=cf_apim) as g:
        g.custom_command('create', 'create_apim_notification_recipient-user')
        g.custom_command('update', 'update_apim_notification_recipient-user')
        g.custom_command('delete', 'delete_apim_notification_recipient-user')
        g.custom_command('list', 'list_apim_notification_recipient-user')
    with self.command_group('apim notification recipient-email', apim_sdk, client_factory=cf_apim) as g:
        g.custom_command('create', 'create_apim_notification_recipient-email')
        g.custom_command('update', 'update_apim_notification_recipient-email')
        g.custom_command('delete', 'delete_apim_notification_recipient-email')
        g.custom_command('list', 'list_apim_notification_recipient-email')
    with self.command_group('apim openid-connect-provider', apim_sdk, client_factory=cf_apim) as g:
        g.custom_command('create', 'create_apim_openid-connect-provider')
        g.custom_command('update', 'update_apim_openid-connect-provider')
        g.custom_command('delete', 'delete_apim_openid-connect-provider')
        g.custom_command('list', 'list_apim_openid-connect-provider')
        g.custom_command('show', 'show_apim_openid-connect-provider')
