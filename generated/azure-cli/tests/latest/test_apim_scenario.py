...
# create_or_update -- create
        ...
        self.cmd('apim api create  --resource-group "rg1" --service-name "apimService1" --api-id "tempgroup" --description "apidescription5200" --display-name "apiname1463" --service-url "http://newechoapi.cloudapp.net/api" --path "newapiPath" --protocols "https,http"', checks=[
        ])
        ...
        self.cmd('apim api create  --resource-group "rg1" --service-name "apimService1" --api-id "echoapiv3" --description "Create Echo API into a new Version using Existing Version Set and Copy all Operations." --api-version "v4" --is-current true --api-version-set-id "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.ApiManagement/service/{{ service_name }}/apiVersionSets/{{ api_version_set_name }}" --subscription-required true --source-api-id "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.ApiManagement/service/{{ service_name }}/apis/{{ api_name }}" --display-name "Echo API2" --service-url "http://echoapi.cloudapp.net/api" --path "echo2" --protocols "http,https"', checks=[
        ])

        self.cmd('apim api create  --resource-group "rg1" --service-name "apimService1" --api-id "echo-api2" --description "Copy of Existing Echo Api including Operations." --is-current true --subscription-required true --source-api-id "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.ApiManagement/service/{{ service_name }}/apis/{{ api_name }}" --display-name "Echo API2" --service-url "http://echoapi.cloudapp.net/api" --path "echo2" --protocols "http,https"', checks=[
        ])

        self.cmd('apim api create  --resource-group "rg1" --service-name "apimService1" --api-id "tempgroup" --description "This is a sample server Petstore server.  You can find out more about Swagger at [http://swagger.io](http://swagger.io) or on [irc.freenode.net, #swagger](http://swagger.io/irc/).  For this sample, you can use the api key `special-key` to test the authorization filters." --display-name "Swagger Petstore" --service-url "http://petstore.swagger.io/v2" --path "petstore" --protocols "https"', checks=[
        ])
...
# create_or_update -- update
        ...
        self.cmd('apim api update  --resource-group "rg1" --service-name "apimService1" --api-id "tempgroup" --description "apidescription5200" --display-name "apiname1463" --service-url "http://newechoapi.cloudapp.net/api" --path "newapiPath" --protocols "https,http"', checks=[
        ])
        ...
        self.cmd('apim api update  --resource-group "rg1" --service-name "apimService1" --api-id "echo-api2" --description "Copy of Existing Echo Api including Operations." --is-current true --subscription-required true --source-api-id "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.ApiManagement/service/{{ service_name }}/apis/{{ api_name }}" --display-name "Echo API2" --service-url "http://echoapi.cloudapp.net/api" --path "echo2" --protocols "http,https"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim authorization-server create  --resource-group "rg1" --service-name "apimService1" --authsid "newauthServer" --description "test server" --authorization-methods "GET" --token-endpoint "https://www.contoso.com/oauth2/token" --support-state true --default-scope "read write" --bearer-token-sending-methods "authorizationHeader" --client-secret "2" --resource-owner-username "un" --resource-owner-password "pwd" --display-name "test2" --client-registration-endpoint "https://www.contoso.com/apps" --authorization-endpoint "https://www.contoso.com/oauth2/auth" --grant-types "authorizationCode,implicit" --client-id "1"', checks=[
        ])
...
# create_or_update -- update
        self.cmd('apim authorization-server update  --resource-group "rg1" --service-name "apimService1" --authsid "newauthServer" --description "test server" --authorization-methods "GET" --token-endpoint "https://www.contoso.com/oauth2/token" --support-state true --default-scope "read write" --bearer-token-sending-methods "authorizationHeader" --client-secret "2" --resource-owner-username "un" --resource-owner-password "pwd" --display-name "test2" --client-registration-endpoint "https://www.contoso.com/apps" --authorization-endpoint "https://www.contoso.com/oauth2/auth" --grant-types "authorizationCode,implicit" --client-id "1"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim create  --resource-group "rg1" --service-name "apimService1" --publisher-email "apim@autorestsdk.com" --publisher-name "autorestsdk" --sku-name "Developer" --sku-capacity "1" --location "Central US"', checks=[
        ])

        self.cmd('apim create  --resource-group "rg1" --service-name "apimService1" --virtual-network-type "External" --publisher-email "admin@live.com" --publisher-name "contoso" --sku-name "Premium" --sku-capacity "1" --location "Central US"', checks=[
        ])

        self.cmd('apim create  --resource-group "rg1" --service-name "apimService1" --publisher-email "apim@autorestsdk.com" --publisher-name "autorestsdk" --sku-name "Consumption" --location "West US"', checks=[
        ])

        self.cmd('apim create  --resource-group "rg1" --service-name "apimService1" --publisher-email "apim@autorestsdk.com" --publisher-name "autorestsdk" --sku-name "Basic" --sku-capacity "1" --location "Central US"', checks=[
        ])

        self.cmd('apim create  --resource-group "rg1" --service-name "apimService1"', checks=[
        ])

        self.cmd('apim create  --resource-group "rg1" --service-name "apimService1" --publisher-email "foobar@live.com" --publisher-name "Contoso Vnext"', checks=[
        ])
...
# create_or_update -- update
        self.cmd('apim update  --resource-group "rg1" --service-name "apimService1" --publisher-email "apim@autorestsdk.com" --publisher-name "autorestsdk" --sku-name "Developer" --sku-capacity "1" --location "Central US"', checks=[
        ])

        self.cmd('apim update  --resource-group "rg1" --service-name "apimService1" --virtual-network-type "External" --publisher-email "admin@live.com" --publisher-name "contoso" --sku-name "Premium" --sku-capacity "1" --location "Central US"', checks=[
        ])

        self.cmd('apim update  --resource-group "rg1" --service-name "apimService1" --publisher-email "apim@autorestsdk.com" --publisher-name "autorestsdk" --sku-name "Consumption" --location "West US"', checks=[
        ])

        self.cmd('apim update  --resource-group "rg1" --service-name "apimService1" --publisher-email "apim@autorestsdk.com" --publisher-name "autorestsdk" --sku-name "Basic" --sku-capacity "1" --location "Central US"', checks=[
        ])

        self.cmd('apim update  --resource-group "rg1" --service-name "apimService1"', checks=[
        ])

        self.cmd('apim update  --resource-group "rg1" --service-name "apimService1" --publisher-email "foobar@live.com" --publisher-name "Contoso Vnext"', checks=[
        ])
...
# delete -- delete
        self.cmd('apim delete  --resource-group "rg1" --service-name "apimService1"', checks=[
        ])
...
# get -- show
        self.cmd('apim show  --resource-group "rg1" --service-name "apimService1"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim template create  --resource-group "rg1" --service-name "apimService1" --template-name "newIssueNotificationMessage" --subject "Your request for $IssueName was successfully received."', checks=[
        ])

        self.cmd('apim template create  --resource-group "rg1" --service-name "apimService1" --template-name "applicationApprovedNotificationMessage" --subject "Your application $AppName is published in the gallery" --body "<!DOCTYPE html >\r\n<html>\r\n  <head />\r\n  <body>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">Dear $DevFirstName $DevLastName,</p>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">\r\n          We are happy to let you know that your request to publish the $AppName application in the gallery has been approved. Your application has been published and can be viewed <a href=\"http://$DevPortalUrl/Applications/Details/$AppId\">here</a>.\r\n        </p>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">Best,</p>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">The $OrganizationName API Team</p>\r\n  </body>\r\n</html>"', checks=[
        ])

        self.cmd('apim template create  --resource-group "rg1" --service-name "apimService1" --template-name "newIssueNotificationMessage"', checks=[
        ])

# create_or_update -- update
        self.cmd('apim template update  --resource-group "rg1" --service-name "apimService1" --template-name "newIssueNotificationMessage" --subject "Your request for $IssueName was successfully received."', checks=[
        ])

        self.cmd('apim template update  --resource-group "rg1" --service-name "apimService1" --template-name "applicationApprovedNotificationMessage" --subject "Your application $AppName is published in the gallery" --body "<!DOCTYPE html >\r\n<html>\r\n  <head />\r\n  <body>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">Dear $DevFirstName $DevLastName,</p>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">\r\n          We are happy to let you know that your request to publish the $AppName application in the gallery has been approved. Your application has been published and can be viewed <a href=\"http://$DevPortalUrl/Applications/Details/$AppId\">here</a>.\r\n        </p>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">Best,</p>\r\n    <p style=\"font-size:12pt;font-family:'Segoe UI'\">The $OrganizationName API Team</p>\r\n  </body>\r\n</html>"', checks=[
        ])

        self.cmd('apim template update  --resource-group "rg1" --service-name "apimService1" --template-name "newIssueNotificationMessage"', checks=[
        ])

# delete -- delete
        self.cmd('apim template delete  --resource-group "rg1" --service-name "apimService1" --template-name "newIssueNotificationMessage"', checks=[
        ])

        self.cmd('apim template delete  --resource-group "rg1" --service-name "apimService1" --template-name "applicationApprovedNotificationMessage"', checks=[
        ])
...
# get -- show
        self.cmd('apim template show  --resource-group "rg1" --service-name "apimService1" --template-name "newIssueNotificationMessage"', checks=[
        ])

        self.cmd('apim template show  --resource-group "rg1" --service-name "apimService1" --template-name "applicationApprovedNotificationMessage"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim identity-provider create  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook" --client-id "facebookid" --client-secret "facebookapplicationsecret"', checks=[
        ])

        self.cmd('apim identity-provider create  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook" --client-id "updatedfacebookid" --client-secret "updatedfacebooksecret"', checks=[
        ])

        self.cmd('apim identity-provider create  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "aad"', checks=[
        ])

# create_or_update -- update
        self.cmd('apim identity-provider update  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook" --client-id "facebookid" --client-secret "facebookapplicationsecret"', checks=[
        ])

        self.cmd('apim identity-provider update  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook" --client-id "updatedfacebookid" --client-secret "updatedfacebooksecret"', checks=[
        ])

        self.cmd('apim identity-provider update  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "aad"', checks=[
        ])

# delete -- delete
        self.cmd('apim identity-provider delete  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook"', checks=[
        ])

        self.cmd('apim identity-provider delete  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook"', checks=[
        ])

        self.cmd('apim identity-provider delete  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "aad"', checks=[
        ])
...
# get -- show
        self.cmd('apim identity-provider show  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook"', checks=[
        ])

        self.cmd('apim identity-provider show  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "facebook"', checks=[
        ])

        self.cmd('apim identity-provider show  --resource-group "rg1" --service-name "apimService1" --identity-provider-name "aad"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim notification create  --resource-group "rg1" --service-name "apimService1" --notification-name "RequestPublisherNotificationMessage"', checks=[
        ])

# create_or_update -- update
        self.cmd('apim notification update  --resource-group "rg1" --service-name "apimService1" --notification-name "RequestPublisherNotificationMessage"', checks=[
        ])
...
# get -- show
        self.cmd('apim notification show  --resource-group "rg1" --service-name "apimService1" --notification-name "RequestPublisherNotificationMessage"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim portalsetting signin create  --resource-group "rg1" --service-name "apimService1" --enabled true', checks=[
        ])
...
# create_or_update -- update
        self.cmd('apim portalsetting signin update  --resource-group "rg1" --service-name "apimService1" --enabled true', checks=[
        ])
...
# get -- show
        self.cmd('apim portalsetting signin show  --resource-group "rg1" --service-name "apimService1"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim portalsetting signup create  --resource-group "rg1" --service-name "apimService1" --enabled true', checks=[
        ])
...
# create_or_update -- update
        self.cmd('apim portalsetting signup update  --resource-group "rg1" --service-name "apimService1" --enabled true', checks=[
        ])
...
# get -- show
        self.cmd('apim portalsetting signup show  --resource-group "rg1" --service-name "apimService1"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim portalsetting delegation create  --resource-group "rg1" --service-name "apimService1" --url "http://contoso.com/delegation" --validation-key "nVF7aKIvr9mV/RM5lOD0sYoi8ThXTRHQP7o66hvUmjCDkPKR3qxPu/otJcNciz2aQdqPuzJH3ECG4TU2yZjQ7Q=="', checks=[
        ])
...
# create_or_update -- update
        self.cmd('apim portalsetting delegation update  --resource-group "rg1" --service-name "apimService1" --url "http://contoso.com/delegation" --validation-key "nVF7aKIvr9mV/RM5lOD0sYoi8ThXTRHQP7o66hvUmjCDkPKR3qxPu/otJcNciz2aQdqPuzJH3ECG4TU2yZjQ7Q=="', checks=[
        ])
...
# get -- show
        self.cmd('apim portalsetting delegation show  --resource-group "rg1" --service-name "apimService1"', checks=[
        ])
...
# create_or_update -- create
        self.cmd('apim property create  --resource-group "rg1" --service-name "apimService1" --prop-id "testprop2" --tags "foo,bar" --secret true --display-name "prop3name" --value "propValue"', checks=[
        ])

        self.cmd('apim property create  --resource-group "rg1" --service-name "apimService1" --prop-id "testprop2" --tags "foo,bar2" --secret true', checks=[
        ])
...
# create_or_update -- update
        self.cmd('apim property update  --resource-group "rg1" --service-name "apimService1" --prop-id "testprop2" --tags "foo,bar" --secret true --display-name "prop3name" --value "propValue"', checks=[
        ])

        self.cmd('apim property update  --resource-group "rg1" --service-name "apimService1" --prop-id "testprop2" --tags "foo,bar2" --secret true', checks=[
        ])
