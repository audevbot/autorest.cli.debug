    ...
    examples:
      - name: CreateDedicatedCloudNode
        text: |-
               ...
               "https://management.azure.com/" --dedicated-cloud-node-name "myNode" --location "westus" \\
    ...
    examples:
      - name: PatchDedicatedCloudNode
        text: |-
               ...
               "https://management.azure.com/" --dedicated-cloud-node-name "myNode"
"""
...
helps['vmwarecs delete'] = """
    ...
    examples:
      - name: DeleteDedicatedCloudNode
        text: |-
               az vmwarecs delete --resource-group "myResourceGroup" --dedicated-cloud-node-name \\
               "myNode"
"""
...
helps['vmwarecs create'] = """
    ...
    examples:
      - name: CreateDedicatedCloudService
        text: |-
               az vmwarecs create --resource-group "myResourceGroup" --dedicated-cloud-service-name \\
               "myService" --location "westus" --gateway-subnet "10.0.0.0"
"""
...
helps['vmwarecs update'] = """
    ...
    examples:
      - name: PatchDedicatedService
        text: |-
               az vmwarecs update --resource-group "myResourceGroup" --dedicated-cloud-service-name \\
               "myService"
"""
...
helps['vmwarecs delete'] = """
    ...
    examples:
      - name: DeleteDedicatedCloudService
        text: |-
               az vmwarecs delete --resource-group "myResourceGroup" --dedicated-cloud-service-name \\
               "myService"
"""
...
helps['vmwarecs create'] = """
    ...
    examples:
      - name: CreateVirtualMachine
        text: |-
               az vmwarecs create --resource-group "myResourceGroup" --referer \\
               "https://management.azure.com/" --virtual-machine-name "myVirtualMachine" --location \\
               "westus2" --amount-of-ram "4096" --number-of-cores "2" --private-cloud-id "/subscriptions/
               {{ subscription_id }}/providers/Microsoft.VMwareCloudSimple/locations/{{ location_name }}/
               privateClouds/{{ private_cloud_name }}" --template-id "/subscriptions/{{ subscription_id }
               }/providers/Microsoft.VMwareCloudSimple/locations/{{ location_name }}/privateClouds/{{ pri
               vate_cloud_name }}/virtualMachineTemplates/{{ virtual_machine_template_name }}"
"""
...
helps['vmwarecs update'] = """
    ...
    examples:
      - name: PatchVirtualMachine
        text: |-
               az vmwarecs update --resource-group "myResourceGroup" --virtual-machine-name \\
               "myVirtualMachine"
"""
    ...
    examples:
      - name: DeleteVirtualMachine
        text: |-
               ...
               "https://management.azure.com/" --virtual-machine-name "myVirtualMachine"
"""
