...
helps['alerts create'] = """
    ...
    examples:
      - name: Create or update a Smart Detector alert rule
        text: |-
               az alerts create --resource-group "MyAlertRules" --alert-rule-name "MyAlertRule" \\
               --description "Sample smart detector alert rule description" --state "Enabled" --severity \\
               "Sev3" --frequency "PT5M" --scope "/subscriptions/b368ca2f-e298-46b7-b0ab-012281956afa/res
               ourceGroups/MyVms/providers/Microsoft.Compute/virtualMachines/vm1"
"""
...
helps['alerts delete'] = """
    ...
    examples:
      - name: Delete a Smart Detector alert rule
        text: |-
               az alerts delete --resource-group "MyAlertRules" --alert-rule-name "MyAlertRule"
"""
