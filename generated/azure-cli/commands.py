...
def load_command_table(self, _):
    ...
    vmwarecs_dedicated_cloud_nodes = CliCommandType(
        operations_tmpl='azext_vmwarecs.vendored_sdks.vmwarecloudsimple.operations._dedicated_cloud_nodes_operations#DedicatedCloudNodesOperations.{}',
    ...
    vmwarecs_dedicated_cloud_services = CliCommandType(
        operations_tmpl='azext_vmwarecs.vendored_sdks.vmwarecloudsimple.operations._dedicated_cloud_services_operations#DedicatedCloudServicesOperations.{}',
    ...
    vmwarecs_virtual_machines = CliCommandType(
        operations_tmpl='azext_vmwarecs.vendored_sdks.vmwarecloudsimple.operations._virtual_machines_operations#VirtualMachinesOperations.{}',
