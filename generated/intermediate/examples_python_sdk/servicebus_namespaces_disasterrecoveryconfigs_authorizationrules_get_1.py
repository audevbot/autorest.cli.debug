...
def run_example():
    ...
    response = mgmt_client.disaster_recovery_configs.get_authorization_rule(RESOURCE_GROUP, NAMESPACE_NAME, DISASTER_RECOVERY_CONFIG_NAME, AUTHORIZATION_RULE_NAME, BODY)
