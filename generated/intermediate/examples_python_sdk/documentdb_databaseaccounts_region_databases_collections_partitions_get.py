...
def run_example():
    ...
    response = mgmt_client.collection_partition_region.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, REGION_NAME, DATABASE_NAME, COLLECTION_NAME, PARTITION_NAME, BODY)
