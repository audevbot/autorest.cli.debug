...
def run_example():
    ...
    response = mgmt_client.database_accounts.get_gremlin_graph_throughput(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, API_NAME, DATABASE_NAME, GRAPH_NAME, SETTING_NAME, BODY)
