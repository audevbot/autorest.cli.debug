...
def run_example():
    ...
    response = mgmt_client.database_accounts.create_update_mongo_dbcollection(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, API_NAME, DATABASE_NAME, COLLECTION_NAME, BODY)
