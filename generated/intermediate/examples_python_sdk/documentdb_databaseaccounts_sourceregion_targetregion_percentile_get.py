...
def run_example():
    ...
    response = mgmt_client.percentile_source_target.list_metrics(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, SOURCE_REGION_NAME, TARGET_REGION_NAME, PERCENTILE_NAME, BODY)
