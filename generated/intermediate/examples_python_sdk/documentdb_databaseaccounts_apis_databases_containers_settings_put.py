...
def run_example():
    ...
    response = mgmt_client.database_accounts.update_sql_container_throughput(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, API_NAME, DATABASE_NAME, CONTAINER_NAME, SETTING_NAME, BODY)
