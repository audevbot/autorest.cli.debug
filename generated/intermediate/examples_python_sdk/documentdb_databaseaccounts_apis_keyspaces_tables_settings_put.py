...
def run_example():
    ...
    response = mgmt_client.database_accounts.update_cassandra_table_throughput(RESOURCE_GROUP, DATABASE_ACCOUNT_NAME, API_NAME, KEYSPACE_NAME, TABLE_NAME, SETTING_NAME, BODY)
