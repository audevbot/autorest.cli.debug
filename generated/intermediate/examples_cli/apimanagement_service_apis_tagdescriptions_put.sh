...
az resource create --id /subscriptions/$SUBSCRIPTION_ID/resourceGroups/$RESOURCE_GROUP/providers/Microsoft.ApiManagement/service/$SERVICE_NAME/apis/$API_NAME/tagDescriptions/$TAG_DESCRIPTION_NAME --api-version 2019-01-01 --is-full-object --properties '
{
  "properties": {
