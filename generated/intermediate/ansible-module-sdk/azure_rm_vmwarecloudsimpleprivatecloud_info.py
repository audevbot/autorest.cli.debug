...
DOCUMENTATION = '''
---
module: azure_rm_vmwarecloudsimpleprivatecloud_info
version_added: '2.9'
...
- name: ListPrivateCloudInLocation
  azure_rm_vmwarecloudsimpleprivatecloud_info:
...
class AzureRMPrivateCloudsInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMPrivateCloudsInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def get(self):
        ...
        try:
            response = self.mgmt_client.private_clouds.get(pc_name=self.name,
