...
DOCUMENTATION = '''
---
module: azure_rm_alertsmanagementsmartgroup_info
version_added: '2.9'
...
class AzureRMSmartGroupsInfo(AzureRMModuleBase):
    ...
    def gethistory(self):
        ...
        try:
            response = self.mgmt_client.smart_groups.get_history(smart_group_id=self.smart_group_id)
    ...
    def getbyid(self):
        ...
        try:
            response = self.mgmt_client.smart_groups.get_by_id(smart_group_id=self.smart_group_id)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
    ...
    def getall(self):
        ...
        try:
            response = self.mgmt_client.smart_groups.get_all()
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
