...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementtenantconfiguration_info
version_added: '2.9'
...
class AzureRMTenantConfigurationInfo(AzureRMModuleBase):
    ...
    def getsyncstate(self):
        ...
        try:
            response = self.mgmt_client.tenant_configuration.get_sync_state(resource_group_name=self.resource_group,
