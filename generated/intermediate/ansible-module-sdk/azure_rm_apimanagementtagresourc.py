...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementtagresourc
version_added: '2.9'
...
class AzureRMTagResource(AzureRMModuleBaseExt):
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.tag_resource.create()
            else:
                response = self.mgmt_client.tag_resource.update()
    ...
    def delete_resource(self):
        ...
        try:
            response = self.mgmt_client.tag_resource.delete()
    ...
    def get_resource(self):
        ...
        found = False
        try:
            response = self.mgmt_client.tag_resource.get()
        except CloudError as e:
            return False
        return response.as_dict()
