...
DOCUMENTATION = '''
---
module: azure_rm_alertsmanagementactionrule_info
version_added: '2.9'
...
class AzureRMActionRulesInfo(AzureRMModuleBase):
    ...
    def getbyname(self):
        ...
        try:
            response = self.mgmt_client.action_rules.get_by_name(resource_group_name=self.resource_group,
                                                                 action_rule_name=self.name)
    ...
    def listbyresourcegroup(self):
        ...
        try:
            response = self.mgmt_client.action_rules.list_by_resource_group(resource_group_name=self.resource_group)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
    ...
    def listbysubscription(self):
        ...
        try:
            response = self.mgmt_client.action_rules.list_by_subscription()
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
