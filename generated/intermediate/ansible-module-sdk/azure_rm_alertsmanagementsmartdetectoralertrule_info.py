...
class AzureRMSmartDetectorAlertRulesInfo(AzureRMModuleBase):
    ...
    def listbyresourcegroup(self):
        ...
        try:
            response = self.mgmt_client.smart_detector_alert_rules.list_by_resource_group(resource_group_name=self.resource_group)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
    ...
    def list(self):
        ...
        try:
            response = self.mgmt_client.smart_detector_alert_rules.list()
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
