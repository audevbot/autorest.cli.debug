...
DOCUMENTATION = '''
---
module: azure_rm_vmwarecloudsimplevirtualmachinetemplate_info
version_added: '2.9'
...
- name: ListVirtualMachineTemplates
  azure_rm_vmwarecloudsimplevirtualmachinetemplate_info:
...
class AzureRMVirtualMachineTemplatesInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMVirtualMachineTemplatesInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def get(self):
        ...
        try:
            response = self.mgmt_client.virtual_machine_templates.get(region_id=self.region_id,
                                                                      ...
                                                                      virtual_machine_template_name=self.name)
...
def main():
    AzureRMVirtualMachineTemplatesInfo()
