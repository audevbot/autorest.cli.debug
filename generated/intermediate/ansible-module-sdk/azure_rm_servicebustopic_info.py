...
class AzureRMTopicsInfo(AzureRMModuleBase):
    ...
    def getauthorizationrule(self):
        ...
        try:
            response = self.mgmt_client.topics.get_authorization_rule(resource_group_name=self.resource_group,
    ...
    def listauthorizationrules(self):
        ...
        try:
            response = self.mgmt_client.topics.list_authorization_rules(resource_group_name=self.resource_group,
                                                                        namespace_name=self.namespace_name,
                                                                        topic_name=self.topic_name)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
