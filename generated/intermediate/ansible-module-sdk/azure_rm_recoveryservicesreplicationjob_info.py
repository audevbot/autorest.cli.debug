...
class AzureRMReplicationJobsInfo(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            response = self.mgmt_client.replication_jobs.get(resource_name=self.resource_name,
    ...
    def list(self):
        ...
        try:
            response = self.mgmt_client.replication_jobs.list(resource_name=self.resource_name,
                                                              resource_group_name=self.resource_group)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
