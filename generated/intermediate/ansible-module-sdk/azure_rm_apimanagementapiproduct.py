...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementapiproduct
version_added: '2.9'
...
class AzureRMApiProduct(AzureRMModuleBaseExt):
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.api_product.create()
            else:
                response = self.mgmt_client.api_product.update()
    ...
    def delete_resource(self):
        ...
        try:
            response = self.mgmt_client.api_product.delete()
    ...
    def get_resource(self):
        ...
        found = False
        try:
            response = self.mgmt_client.api_product.get()
        except CloudError as e:
            return False
        return response.as_dict()
