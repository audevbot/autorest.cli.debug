...
class AzureRMAlertsInfo(AzureRMModuleBase):
    ...
    def gethistory(self):
        ...
        try:
            response = self.mgmt_client.alerts.get_history(alert_id=self.alert_id)
    ...
    def getbyid(self):
        ...
        try:
            response = self.mgmt_client.alerts.get_by_id(alert_id=self.alert_id)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
    ...
    def getsummary(self):
        ...
        try:
            response = self.mgmt_client.alerts.get_summary(groupby=self.groupby)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
    ...
    def getall(self):
        ...
        try:
            response = self.mgmt_client.alerts.get_all()
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
    ...
    def metadata(self):
        ...
        try:
            response = self.mgmt_client.alerts.meta_data(identifier=self.identifier)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
