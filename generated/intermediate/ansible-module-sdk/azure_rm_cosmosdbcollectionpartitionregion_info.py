...
DOCUMENTATION = '''
---
module: azure_rm_cosmosdbcollectionpartitionregion_info
version_added: '2.9'
...
class AzureRMCollectionPartitionRegionInfo(AzureRMModuleBase):
    ...
    def listmetrics(self):
        ...
        try:
            response = self.mgmt_client.collection_partition_region.list_metrics(resource_group_name=self.resource_group,
