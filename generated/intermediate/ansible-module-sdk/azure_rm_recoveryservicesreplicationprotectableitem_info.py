...
class AzureRMReplicationProtectableItemsInfo(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            response = self.mgmt_client.replication_protectable_items.get(resource_name=self.resource_name,
                                                                          resource_group_name=self.resource_group,
                                                                          fabric_name=self.fabric_name,
                                                                          protection_container_name=self.protection_container_name,
                                                                          protectable_item_name=self.name)
    ...
    def listbyreplicationprotectioncontainers(self):
        ...
        try:
            response = self.mgmt_client.replication_protectable_items.list_by_replication_protection_containers(resource_name=self.resource_name,
                                                                                                                resource_group_name=self.resource_group,
                                                                                                                fabric_name=self.fabric_name,
                                                                                                                protection_container_name=self.protection_container_name)
        except CloudError as e:
