...
class AzureRMReplicationProtectedItems(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            name=dict(
                type='str',
                updatable=False,
                disposition='replicated_protected_item_name',
                required=true
            ),
            policy_id=dict(
                type='str',
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.replication_protected_items.create(resource_name=self.resource_name,
                ...
                response = self.mgmt_client.replication_protected_items.update(resource_name=self.resource_name,
                                                                               resource_group_name=self.resource_group,
                                                                               fabric_name=self.fabric_name,
                                                                               protection_container_name=self.protection_container_name,
                                                                               replicated_protected_item_name=self.name,
                                                                               update_protection_input=self.updateProtectionInput)
    ...
    def delete_resource(self):
        ...
        try:
            response = self.mgmt_client.replication_protected_items.delete(resource_name=self.resource_name,
                                                                           resource_group_name=self.resource_group,
                                                                           fabric_name=self.fabric_name,
                                                                           protection_container_name=self.protection_container_name,
                                                                           replicated_protected_item_name=self.name,
                                                                           disable_protection_input=self.disableProtectionInput)
    ...
    def get_resource(self):
        ...
        found = False
        try:
            response = self.mgmt_client.replication_protected_items.get(resource_name=self.resource_name,
                                                                        resource_group_name=self.resource_group,
                                                                        fabric_name=self.fabric_name,
                                                                        protection_container_name=self.protection_container_name,
                                                                        replicated_protected_item_name=self.name)
