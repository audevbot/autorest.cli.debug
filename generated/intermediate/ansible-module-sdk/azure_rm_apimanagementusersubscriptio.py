...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementusersubscriptio
version_added: '2.9'
...
class AzureRMUserSubscription(AzureRMModuleBaseExt):
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.user_subscription.create()
            else:
                response = self.mgmt_client.user_subscription.update()
    ...
    def delete_resource(self):
        ...
        try:
            response = self.mgmt_client.user_subscription.delete()
    ...
    def get_resource(self):
        ...
        found = False
        try:
            response = self.mgmt_client.user_subscription.get()
        except CloudError as e:
            return False
        return response.as_dict()
