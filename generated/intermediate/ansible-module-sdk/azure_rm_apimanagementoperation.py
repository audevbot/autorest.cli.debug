...
class AzureRMApiManagementOperations(AzureRMModuleBaseExt):
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.api_management_operations.create()
            else:
                response = self.mgmt_client.api_management_operations.update()
    ...
    def delete_resource(self):
        ...
        try:
            response = self.mgmt_client.api_management_operations.delete()
    ...
    def get_resource(self):
        ...
        found = False
        try:
            response = self.mgmt_client.api_management_operations.get()
        except CloudError as e:
            return False
        return response.as_dict()
