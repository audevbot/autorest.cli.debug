...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementregion
version_added: '2.9'
...
class AzureRMRegion(AzureRMModuleBaseExt):
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.region.create()
            else:
                response = self.mgmt_client.region.update()
    ...
    def delete_resource(self):
        ...
        try:
            response = self.mgmt_client.region.delete()
    ...
    def get_resource(self):
        ...
        found = False
        try:
            response = self.mgmt_client.region.get()
        except CloudError as e:
            return False
        return response.as_dict()
