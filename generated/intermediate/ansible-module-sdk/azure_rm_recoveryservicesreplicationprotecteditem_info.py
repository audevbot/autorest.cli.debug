...
class AzureRMReplicationProtectedItemsInfo(AzureRMModuleBase):
    ...
    def listbyreplicationprotectioncontainers(self):
        ...
        try:
            response = self.mgmt_client.replication_protected_items.list_by_replication_protection_containers(resource_name=self.resource_name,
                                                                                                              resource_group_name=self.resource_group,
                                                                                                              fabric_name=self.fabric_name,
                                                                                                              protection_container_name=self.protection_container_name)
        except CloudError as e:
    ...
    def list(self):
        ...
        try:
            response = self.mgmt_client.replication_protected_items.list(resource_name=self.resource_name,
                                                                         resource_group_name=self.resource_group)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
