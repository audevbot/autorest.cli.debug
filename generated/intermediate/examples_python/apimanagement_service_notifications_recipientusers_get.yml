...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.ApiManagement/service/" + SERVICE_N + "/notifications/" + NOTIFICATION_N + "/recipientUsers", query_parameters)
