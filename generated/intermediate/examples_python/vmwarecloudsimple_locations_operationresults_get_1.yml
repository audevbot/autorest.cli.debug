...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/providers/Microsoft.VMwareCloudSimple/locations/" + LOCATION_N + "/operationResults/" + OPERATION_RESULT_N, query_parameters)
