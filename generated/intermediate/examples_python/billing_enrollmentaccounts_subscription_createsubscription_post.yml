...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/providers/Microsoft.Billing/enrollmentAccounts/" + ENROLLMENT_ACCOUNT_N + "/providers/Microsoft.Subscription/createSubscription", query_parameters)
