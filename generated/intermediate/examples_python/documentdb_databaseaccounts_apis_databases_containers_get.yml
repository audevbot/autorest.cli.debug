...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.DocumentDB/databaseAccounts/" + DATABASE_ACCOUNT_N + "/apis/" + API_N + "/databases/" + DATABASE_N + "/containers", query_parameters)
