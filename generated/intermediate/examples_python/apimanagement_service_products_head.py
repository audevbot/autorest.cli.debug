...
def run_example():
    ...
    operation_config = {}
    request = service_client.head("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.ApiManagement/service/" + SERVICE_N + "/products/" + PRODUCT_N, query_parameters)
