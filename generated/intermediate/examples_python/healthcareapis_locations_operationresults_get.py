...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/providers/Microsoft.HealthcareApis/locations/" + LOCATION_N + "/operationresults/" + OPERATIONRESULT_N, query_parameters)
