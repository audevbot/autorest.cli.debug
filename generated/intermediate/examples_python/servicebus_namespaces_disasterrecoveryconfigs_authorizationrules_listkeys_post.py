...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.ServiceBus/namespaces/" + NAMESPACE_N + "/disasterRecoveryConfigs/" + DISASTER_RECOVERY_CONFIG_N + "/AuthorizationRules/" + AUTHORIZATION_RULE_N + "/listKeys", query_parameters)
