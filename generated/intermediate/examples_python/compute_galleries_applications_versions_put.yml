...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.Compute/galleries/" + GALLERY_N + "/applications/" + APPLICATION_N + "/versions/" + VERSION_N, query_parameters)
