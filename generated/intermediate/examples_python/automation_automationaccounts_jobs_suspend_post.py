...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.Automation/automationAccounts/" + AUTOMATION_ACCOUNT_N + "/jobs/" + JOB_N + "/suspend", query_parameters)
