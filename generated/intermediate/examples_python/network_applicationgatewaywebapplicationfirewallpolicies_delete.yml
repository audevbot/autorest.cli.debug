...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/" + APPLICATION_GATEWAY_WEB_APPLICATION_FIREWALL_POLICY_N, query_parameters)
