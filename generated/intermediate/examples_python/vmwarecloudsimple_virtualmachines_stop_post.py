...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.VMwareCloudSimple/virtualMachines/" + VIRTUAL_MACHINE_N + "/stop", query_parameters)
