...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.HealthcareApis/services/" + SERVICE_N, query_parameters)
