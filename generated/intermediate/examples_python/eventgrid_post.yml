...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/{scope}/" + {SCOPE}_N + "/Microsoft.EventGrid/" + MICROSOFT.EVENT_GRID_N + "/{eventSubscriptionName}/" + {EVENT_SUBSCRIPTION_NAME}_N, query_parameters)
