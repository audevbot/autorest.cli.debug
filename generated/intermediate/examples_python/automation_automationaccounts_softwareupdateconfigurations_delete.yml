...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.Automation/automationAccounts/" + AUTOMATION_ACCOUNT_N + "/softwareUpdateConfigurations/" + SOFTWARE_UPDATE_CONFIGURATION_N, query_parameters)
