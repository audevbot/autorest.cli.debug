...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/providers/Microsoft.VMwareCloudSimple/locations/" + LOCATION_N + "/privateClouds/" + PRIVATE_CLOUD_N + "/resourcePools/" + RESOURCE_POOL_N, query_parameters)
