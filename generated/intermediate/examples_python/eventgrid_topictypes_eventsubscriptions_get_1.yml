...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.EventGrid/topicTypes/" + TOPIC_TYPE_N + "/eventSubscriptions", query_parameters)
