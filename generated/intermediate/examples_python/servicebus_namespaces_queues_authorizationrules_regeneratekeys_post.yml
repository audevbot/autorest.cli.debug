...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.ServiceBus/namespaces/" + NAMESPACE_N + "/queues/" + QUEUE_N + "/authorizationRules/" + AUTHORIZATION_RULE_N + "/regenerateKeys", query_parameters)
