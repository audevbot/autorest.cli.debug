...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.RecoveryServices/vaults/" + VAULT_N + "/extendedInformation/" + EXTENDED_INFORMATION_N, query_parameters)
