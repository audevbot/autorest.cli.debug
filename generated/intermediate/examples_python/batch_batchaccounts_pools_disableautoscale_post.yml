...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.Batch/batchAccounts/" + BATCH_ACCOUNT_N + "/pools/" + POOL_N + "/disableAutoScale", query_parameters)
