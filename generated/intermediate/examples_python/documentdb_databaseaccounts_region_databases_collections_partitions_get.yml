...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.DocumentDB/databaseAccounts/" + DATABASE_ACCOUNT_N + "/region/" + REGION_N + "/databases/" + DATABASE_N + "/collections/" + COLLECTION_N + "/partitions/" + PARTITION_N, query_parameters)
