...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.ContainerService/openShiftManagedClusters/" + OPEN_SHIFT_MANAGED_CLUSTER_N, query_parameters)
