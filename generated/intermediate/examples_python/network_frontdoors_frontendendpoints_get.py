...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.Network/frontDoors/" + FRONT_DOOR_N + "/frontendEndpoints", query_parameters)
