...
def run_example():
    ...
    operation_config = {}
    request = service_client.patch("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.ApiManagement/service/" + SERVICE_N + "/backends/" + BACKEND_N, query_parameters)
