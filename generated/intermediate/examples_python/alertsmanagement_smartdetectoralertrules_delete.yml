...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/microsoft.alertsManagement/smartDetectorAlertRules/" + SMART_DETECTOR_ALERT_RULE_N, query_parameters)
