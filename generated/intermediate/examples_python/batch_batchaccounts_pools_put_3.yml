...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.Batch/batchAccounts/" + BATCH_ACCOUNT_N + "/pools/" + POOL_N, query_parameters)
