...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.VMwareCloudSimple/dedicatedCloudServices/" + DEDICATED_CLOUD_SERVICE_N, query_parameters)
