...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.ApiManagement/service/" + SERVICE_N + "/apis/" + API_N + "/operations/" + OPERATION_N + "/policies/" + POLICY_N, query_parameters)
