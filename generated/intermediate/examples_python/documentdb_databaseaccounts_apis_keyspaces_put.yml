...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/Microsoft.DocumentDB/databaseAccounts/" + DATABASE_ACCOUNT_N + "/apis/" + API_N + "/keyspaces/" + KEYSPACE_N, query_parameters)
