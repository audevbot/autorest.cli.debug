...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION + "/resourceGroups/" + RESOURCE_GR + "/providers/{providerNamespace}/{resourceTypeName}/" + {RESOURCE_TYPE_NAME}_N + "/providers/Microsoft.EventGrid/eventSubscriptions", query_parameters)
