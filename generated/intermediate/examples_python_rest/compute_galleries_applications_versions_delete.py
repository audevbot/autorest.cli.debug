...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.Compute/galleries/" + GALLERY_NAME + "/applications/" + APPLICATION_NAME + "/versions/" + VERSION_NAME, query_parameters)
