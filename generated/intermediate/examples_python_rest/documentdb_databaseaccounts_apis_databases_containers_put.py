...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.DocumentDB/databaseAccounts/" + DATABASE_ACCOUNT_NAME + "/apis/" + API_NAME + "/databases/" + DATABASE_NAME + "/containers/" + CONTAINER_NAME, query_parameters)
