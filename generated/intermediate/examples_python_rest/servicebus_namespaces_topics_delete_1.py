...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.ServiceBus/namespaces/" + NAMESPACE_NAME + "/topics/" + TOPIC_NAME + "/subscriptions/" + SUBSCRIPTION_ID, query_parameters)
