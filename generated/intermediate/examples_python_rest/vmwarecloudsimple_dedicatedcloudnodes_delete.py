...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.VMwareCloudSimple/dedicatedCloudNodes/" + DEDICATED_CLOUD_NODE_NAME, query_parameters)
