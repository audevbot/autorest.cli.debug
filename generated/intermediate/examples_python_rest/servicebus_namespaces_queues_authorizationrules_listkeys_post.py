...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.ServiceBus/namespaces/" + NAMESPACE_NAME + "/queues/" + QUEUE_NAME + "/authorizationRules/" + AUTHORIZATION_RULE_NAME + "/ListKeys", query_parameters)
