...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/{scope}/" + {SCOPE}_NAME + "/Microsoft.EventGrid/" + MICROSOFT.EVENT_GRID_NAME + "/{eventSubscriptionName}/" + {EVENT_SUBSCRIPTION_NAME}_NAME, query_parameters)
