...
def run_example():
    ...
    operation_config = {}
    request = service_client.head("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.ApiManagement/service/" + SERVICE_NAME + "/apis/" + API_NAME + "/diagnostics/" + DIAGNOSTIC_NAME, query_parameters)
