...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.VMwareCloudSimple/virtualMachines/" + VIRTUAL_MACHINE_NAME + "/stop", query_parameters)
