...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/{providerNamespace}/{resourceTypeName}/" + {RESOURCE_TYPE_NAME}_NAME + "/providers/Microsoft.EventGrid/eventTypes", query_parameters)
