...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION_ID + "/providers/Microsoft.EventGrid/locations/" + LOCATION_NAME + "/topicTypes/" + TOPIC_TYPE_NAME + "/eventSubscriptions", query_parameters)
