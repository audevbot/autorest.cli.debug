...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION_ID + "/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies", query_parameters)
