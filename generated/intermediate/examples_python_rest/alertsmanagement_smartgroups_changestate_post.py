...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION_ID + "/providers/Microsoft.AlertsManagement/smartGroups/" + SMART_GROUP_NAME + "/changeState", query_parameters)
