...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.DocumentDB/databaseAccounts/" + DATABASE_ACCOUNT_NAME + "/region/" + REGION_NAME + "/databases/" + DATABASE_NAME + "/collections/" + COLLECTION_NAME + "/metrics", query_parameters)
