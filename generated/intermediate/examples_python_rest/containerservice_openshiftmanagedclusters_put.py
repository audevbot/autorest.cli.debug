...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.ContainerService/openShiftManagedClusters/" + OPEN_SHIFT_MANAGED_CLUSTER_NAME, query_parameters)
