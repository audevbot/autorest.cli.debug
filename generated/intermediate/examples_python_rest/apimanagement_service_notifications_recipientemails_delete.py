...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.ApiManagement/service/" + SERVICE_NAME + "/notifications/" + NOTIFICATION_NAME + "/recipientEmails/" + RECIPIENT_EMAIL_NAME, query_parameters)
