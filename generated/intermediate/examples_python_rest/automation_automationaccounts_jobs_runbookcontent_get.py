...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.Automation/automationAccounts/" + AUTOMATION_ACCOUNT_NAME + "/jobs/" + JOB_NAME + "/runbookContent", query_parameters)
