...
def run_example():
    ...
    operation_config = {}
    request = service_client.delete("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/microsoft.alertsManagement/smartDetectorAlertRules/" + SMART_DETECTOR_ALERT_RULE_NAME, query_parameters)
