...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.VMwareCloudSimple/dedicatedCloudServices/" + DEDICATED_CLOUD_SERVICE_NAME, query_parameters)
