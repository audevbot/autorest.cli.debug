...
def run_example():
    ...
    operation_config = {}
    request = service_client.post("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.RecoveryServices/locations/" + LOCATION_NAME + "/checkNameAvailability", query_parameters)
