...
def run_example():
    ...
    operation_config = {}
    request = service_client.get("/subscriptions/" + SUBSCRIPTION_ID + "/providers/Microsoft.HealthcareApis/locations/" + LOCATION_NAME + "/operationresults/" + OPERATIONRESULT_NAME, query_parameters)
