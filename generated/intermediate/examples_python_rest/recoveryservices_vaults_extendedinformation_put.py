...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.RecoveryServices/vaults/" + VAULT_NAME + "/extendedInformation/" + EXTENDED_INFORMATION_NAME, query_parameters)
