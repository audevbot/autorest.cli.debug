...
DOCUMENTATION = '''
---
module: azure_rm_cosmosdbpercentiletarge
version_added: '2.9'
...
class AzureRMPercentileTarget(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("PercentileTarget instance doesn't exist")
            ...
            self.log('PercentileTarget instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the PercentileTarget instance')
            ...
            self.log('PercentileTarget instance deleted')
            self.results['changed'] = True
            ...
            self.log('PercentileTarget instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the PercentileTarget instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("PercentileTarget instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the PercentileTarget instance.')
        if found is True:
            return response
