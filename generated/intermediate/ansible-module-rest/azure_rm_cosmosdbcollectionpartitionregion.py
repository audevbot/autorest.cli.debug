...
DOCUMENTATION = '''
---
module: azure_rm_cosmosdbcollectionpartitionregion
version_added: '2.9'
...
class AzureRMCollectionPartitionRegion(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("CollectionPartitionRegion instance doesn't exist")
            ...
            self.log('CollectionPartitionRegion instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the CollectionPartitionRegion instance')
            ...
            self.log('CollectionPartitionRegion instance deleted')
            self.results['changed'] = True
            ...
            self.log('CollectionPartitionRegion instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the CollectionPartitionRegion instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("CollectionPartitionRegion instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the CollectionPartitionRegion instance.')
        if found is True:
            return response
