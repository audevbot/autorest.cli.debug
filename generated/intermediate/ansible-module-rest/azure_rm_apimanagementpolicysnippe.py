...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementpolicysnippe
version_added: '2.9'
...
class AzureRMPolicySnippet(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("PolicySnippet instance doesn't exist")
            ...
            self.log('PolicySnippet instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the PolicySnippet instance')
            ...
            self.log('PolicySnippet instance deleted')
            self.results['changed'] = True
            ...
            self.log('PolicySnippet instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the PolicySnippet instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("PolicySnippet instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the PolicySnippet instance.')
        if found is True:
            return response
