...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementusergrou
version_added: '2.9'
...
class AzureRMUserGroup(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("UserGroup instance doesn't exist")
            ...
            self.log('UserGroup instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the UserGroup instance')
            ...
            self.log('UserGroup instance deleted')
            self.results['changed'] = True
            ...
            self.log('UserGroup instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the UserGroup instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("UserGroup instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the UserGroup instance.')
        if found is True:
            return response
