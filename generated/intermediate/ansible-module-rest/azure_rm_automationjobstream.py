...
DOCUMENTATION = '''
---
module: azure_rm_automationjobstream
version_added: '2.9'
...
class AzureRMJobStream(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            job_stream_id=dict(
                type='str',
                disposition='/properties/jobStreamId'
            ),
            time=dict(
                type='datetime',
            ...
            stream_type=dict(
                type='str',
                disposition='/properties/streamType',
                choices=['Progress',
                         'Output',
                         'Warning',
                         'Error',
            ...
            stream_text=dict(
                type='str',
                disposition='/properties/streamText'
            ),
            summary=dict(
                type='str',
                disposition='/properties/*'
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("JobStream instance doesn't exist")
            ...
            self.log('JobStream instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the JobStream instance')
            ...
            self.log('JobStream instance deleted')
            self.results['changed'] = True
            ...
            self.log('JobStream instance unchanged')
    ...
    def create_update_resource(self):
        # self.log('Creating / Updating the JobStream instance {0}'.format(self.))
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("JobStream instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the JobStream instance.')
        if found is True:
            return response
